    ...
    try:
            ...
            while True:
                ...
                if not logfile is None:
                    ...
                    if predict_every_epoch and (not epoch==num_epochs):
                        ...
                        current_result_0 = dev_metrics[0]  # Accuracy
                        print("Dev {} after epoch {}: {}".format('Accuracy_dev', epoch, current_result_0))
                        current_result_1 = dev_metrics[3]  # Accuracy
                        print("Dev {} after epoch {}: {}".format('F1_dev', epoch, current_result_1))

                        current_result_2 = test_metrics[0]  # Accuracy
                        print("Dev {} after epoch {}: {}".format('Accuracy_test', epoch, current_result_2))
                        current_result_3 = test_metrics[3]  # Accuracy
                        print("Dev {} after epoch {}: {}".format('F1_test', epoch, current_result_3))
        ...
        with tf.Session(config=session_config) as sess: #config=tf.ConfigProto(log_device_placement=True)
            ...
            if print_dim:
                ...
                stopping_criterion_1 = 'Accuracy'
                print('Dev {}: {}'.format(stopping_criterion_1, opt['score'][stopping_criterion_1]['dev']))
                print('Test {}: {}'.format(stopping_criterion_1, opt['score'][stopping_criterion_1]['test']))
                stopping_criterion_2 = 'F1'
                print('Dev {}: {}'.format(stopping_criterion_2, opt['score'][stopping_criterion_2]['dev']))
                print('Test {}: {}'.format(stopping_criterion_2, opt['score'][stopping_criterion_2]['test']))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-gpu', action="store", dest="gpu", type=int, default=0)
