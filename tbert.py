...
# example usage: python tbert.py -learning_rate 5e-05 -gpu 0 -topic_type ldamallet -topic word -dataset MSRP --debug

parser = argparse.ArgumentParser()
parser.register("type", "bool", lambda v: v.lower() == "true")
parser.add_argument('-dataset', action="store", dest="dataset", type=str, default='MSRP')
parser.add_argument('-learning_rate', action="store", dest="learning_rate", type=str, default='5e-5') # learning_rates = [5e-5, 2e-5, 4e-5, 3e-5]
...
parser.add_argument('-gpu', action="store", dest="gpu", type=int, default=0)#-1
...
parser.add_argument('-topic_type', action="store", dest="topic_type", type=str, default='ldamallet') #ldamallet
